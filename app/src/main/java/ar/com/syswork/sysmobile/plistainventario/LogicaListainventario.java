...
import ar.com.syswork.sysmobile.pcargainventario.PantallaManagerCargaInventario;
...
public class LogicaListainventario {
    ...
    public void consultarInventario(Long _idinventanrio)
    {
        ...
        Intent intent = new Intent(this.a, ar.com.syswork.sysmobile.pcargainventario.CargaInventarioActivity.class);
